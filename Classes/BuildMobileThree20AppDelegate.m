...
#import "BuildMobileThree20AppDelegate.h"
...
@implementation BuildMobileThree20AppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
	[TTStyleSheet setGlobalStyleSheet:[[[BMDefaultStylesheet alloc] init] autorelease]];
    ...
    [map from:@"tt://buildmobile" toSharedViewController:[BMFeedListController class]];
